...
int Puntuacio(char *tauler){
    ...
    for(int i=N-1; 0<=i; i--){
        for(int j=0; j<N; j++){
            if(tauler[i*N+j]==1 && Caselles[i*N+j]!=-1){
                resta=resta-Puntuacio_Dreta(tauler, Caselles, recompte, 1, i, j);
            }
        }
    }
    //Omplir caselles de 0's
    ...
    for(int i=N-1; 0<=i; i--){
        for(int j=0; j<N; j++){
            if(tauler[i*N+j]==2 && Caselles[i*N+j]!=-1){
                suma=suma+Puntuacio_Amunt(tauler, Caselles, recompte, 2, i, j);
            }
        }
    }
    //Omplir caselles de 0's
    ...
    //ORDINADOR AMUNT ESQUERRA
    for(int i=N-1; 0<=i; i--){
        for(int j=0; j<N; j++){
            if(tauler[i*N+j]==2 && Caselles[i*N+j]!=-1){
                suma=suma+Puntuacio_Amunt_Esquerra(tauler, Caselles, recompte, 2, i, j);
            }
        }
    }
    //Omplir caselles de 0's
    ...
    //ORDINADOR AMUNT DRETA
    for(int i=N-1; 0<=i; i--){
        for(int j=0; j<N; j++){
            if(tauler[i*N+j]==2 && Caselles[i*N+j]!=-1){
                suma=suma+Puntuacio_Amunt_Dreta(tauler, Caselles, recompte, 2, i, j);
            }
        }
    }
    //Omplir caselles de 0's
    ...
    for(int i=N-1; 0<=i; i--){
        for(int j=0; j<N; j++){
            if(tauler[i*N+j]==2 && Caselles[i*N+j]!=-1){
                suma=suma+Puntuacio_Dreta(tauler, Caselles, recompte, 2, i, j);
            }
        }
    }
    //Omplir caselles de 0's
